        ...
        |f|
          ...
          if !f_last_quote.nil? and f_last_quote.close>0
            ...
            f_parsed['forecasts'].each do |forecast|
              ...
              if @db[:Accuchecks].find({:symbol => f_parsed['symbol'],:date => f_last_quote.trade_date, :algorithm => forecast['algorithm_name'] }).count == 0  
